package com.oraro.floatingbutton;
...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        attr.recycle();
        setTag(R.id.fab_label, new TextView(context));
        updateCircleSize();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(mTitle, getWidth()/2, getHeight()*4/7, paint);
    }
    ...
    public void setTitle(String title) {
        ...
        Log.i(TAG, "setTitle..label=" + label + ",title=" + title);
        if (label != null) {
            label.setText(title);
        }
    }

...
import com.oraro.genealogy.data.entity.Entity;
...
public abstract class BaseListAdapter<T extends Entity> extends RecyclerView.Adapter {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int type) {
        ...
        switch (type) {
            ...
            default:
                ...
                Log.i(TAG,"holder="+holder.getItemViewType());
                return holder;
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder h, int position) {
        Log.i(TAG, "onBindViewHolder.."+position+"..."+h.getItemViewType());
        switch (h.getItemViewType()) {
            ...
            case VIEW_TYPE_FOOTER:
                Log.i(TAG, "VIEW_TYPE_FOOTER.."+mState+",,"+onLoadingListener);
